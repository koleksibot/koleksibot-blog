    ...
    <Layout>
      ...
      <div className={style.container}>
        ...
        <div className={style.content}>
          <h1>Hi, I'm Arryangga</h1>
          <p>
            I’m a web and mobile developer with over 5 years of professional
            experience in the software industry. I specialize in creating custom
            web & mobile app for other businesses, focusing primarily on front
            end development. I also blog on topics relating to web development,
            life, remote work and work-life balance.
          </p>
        </div>
      </div>
    </Layout>
